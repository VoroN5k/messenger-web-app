...
export function ReplyBubble({
    ...
    return (
        <div
            onClick={onScrollTo}
            className={`text-xs rounded-lg px-2.5 py-1.5 mb-1.5 border-l-2 transition-opacity
                ${onScrollTo ? 'cursor-pointer hover:opacity-80' : 'cursor-default'}
                ${isMe
