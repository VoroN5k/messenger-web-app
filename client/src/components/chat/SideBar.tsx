import { User as UserIcon, LogOut, Bell, BellOff } from "lucide-react";
                    ...
                    return (
                        ...
                        >
                            <div className="relative">
                                ...
                                <span className={`absolute bottom-0 right-0 w-3.5 h-3.5 rounded-full border-[2.5px] border-white
